...
def generate_single_report(
    ...
    if shap_values:
        story.append(
            Paragraph("Top Contributing Risk Factors (SHAP)", styles["section"])
        )
        story.append(
            Paragraph(
    ...
    # ── Disclaimer ────────────────────────────────────────────
    story.append(
        HRFlowable(width="100%", thickness=0.5, color=SLATE_500, spaceBefore=10)
    )
    story.append(
        Paragraph(
...
def generate_batch_summary_report(
    ...
    # ── Header ────────────────────────────────────────────────
    story.append(
        Paragraph("Batch Diabetes Risk Assessment — Summary Report", styles["title"])
    )
    story.append(
        Paragraph(
            f"File: {filename}  ·  "
    ...
    if top_factors:
        story.append(
            Paragraph("Top Population Risk Factors (Global SHAP)", styles["section"])
        )
    ...
    # ── Footer ────────────────────────────────────────────────
    story.append(
        HRFlowable(width="100%", thickness=0.5, color=SLATE_500, spaceBefore=14)
    )
    story.append(
        Paragraph(
